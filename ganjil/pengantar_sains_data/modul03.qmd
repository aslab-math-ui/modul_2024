...
Kebetulan, materi modul kali ini adalah revisi dari [modul PSD tahun lalu](../../../2023/ganjil/pengantar_sains_data/Pekan%201/modul1.qmd). Silakan intip kalau mau :)
...
```{r}
df1 <- read.csv("https://raw.githubusercontent.com/aslab-math-ui/asset/main/pengantar_sains_data/datasets/Iris.csv")
```
