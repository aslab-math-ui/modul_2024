...
![Gambar 1. Untuk memasukkan |>, pastikan “Use native pipe operator” option is checked.](https://raw.githubusercontent.com/aslab-math-ui/asset/main/model_linier/static/shortcut-pipe.png)
...
```{r}
train <- read.csv("https://raw.githubusercontent.com/aslab-math-ui/asset/main/model_linier/datasets/train.csv")
test <- read.csv("https://raw.githubusercontent.com/aslab-math-ui/asset/main/model_linier/datasets/test.csv")
```
